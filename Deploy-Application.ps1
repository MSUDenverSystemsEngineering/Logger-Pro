...
Try {
	...
	[string]$appVendor = 'Vernier'
	[string]$appName = 'Logger Pro'
	[string]$appVersion = '3.16.2'
	[string]$appArch = 'x86'
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '1.0.0'
	[string]$appScriptDate = '8/16/2022'
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		if ($out -eq "Cancel") {
			Write-Log -Message "Installation cancelled by user." -Severity 3
			Exit-Script -ExitCode = 60012
		}
		else {
			Show-InstallationProgress
			Execute-Process -Path "$dirFiles\installer.bat"
		}
		...
		## Removes setup file that can break branchecache installations
		If (Test-Path -Path "$dirFiles\setup.log" -PathType Leaf)
		{
			Remove-Item -Path "$dirFiles\setup.log"
		}
	}
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Show-InstallationWelcome -CloseApps 'loggerpro' -CloseAppsCountdown 60
		...
		Execute-MSI -Path "$dirFiles\Logger Pro 3.msi" -Action "Uninstall"
	...
	ElseIf ($deploymentType -ieq 'Repair')
	{
		...
		Execute-MSI -Path "$dirFiles\Logger Pro 3.msi" -Action "Repair"
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDXu+TEjWNtIllJ
# SGxdR7VGcIgqtRXOLWEb1UwM1N8k2aCCH8EwggVvMIIEV6ADAgECAhBI/JO0YFWU
...
# AYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgeKuOZEgvYasA
# eTDCEnTag/uFqBsgOH9VhYC3htKyIBMwDQYJKoZIhvcNAQEBBQAEggGAWbblDhOV
# sLyV1eHGKfHXeEEiTm2OV6UagFazGcKwGzXI3kTf2vJhL5CvySK72ztvWDevhPdp
# iLRJw1j742UrIRgo80/bjvM60L3hY5OfHYwTcMfmBm+fqcwgqMj0d7NFLY8LUFa5
# ALjc3xhxLYxbGJG3LdBR8E1N4P1wPxyUeHLas4cqAz1jJMx3kl89J1zjqsRjbuL8
# TGEpBhGC/hjEp0R8ekzZvhdFnbHSzM53P9ZtQmx0M+kXX19qaIgAOOrASWOVdNk3
# 58MTnZiLx2JJlD3JFIzsrRAU5pviUX4AkVlUClRsK4QVqnB/b3R4NcG9U8X5h5a1
# HHV1vUBcHG2Hb0I/RawaXA2xrNQ4iEUFSHkxoLKKUUIc8ZaJ3imsvvm22oWDYp+y
# q1If+QNsaZ+OX4aotn/S4KKhdlyunezPo0++VuzJ7axbtCq1oiYRew0xc1e3HEMp
# KdIZOMXKWUHEAs6pRnSVI6Zq9ROTh/KfZwyybp0fHkBtaghsQ6fRNFhuoYIDTDCC
...
# BgkqhkiG9w0BCQMxCwYJKoZIhvcNAQcBMBwGCSqGSIb3DQEJBTEPFw0yMjA4MTcx
# MDEyMDVaMD8GCSqGSIb3DQEJBDEyBDAC+6DdRZFrjRhbWQzcmVf/W+bXnFYCYZEs
# TmpaA/gipf3wNCgallIRxx+thSyJ1EIwDQYJKoZIhvcNAQEBBQAEggIAB5/EdqG/
# 8Du2URf2vamXgJxooz1DIsGn3ZidrrV/oRdBt4LxYIeG48prBIqwmbYVCl8J9Afu
# rKR5vcMfzfXQ1426OeFD4jqUA3j74C2e7OhxNXaGqOZl9OgVHLf6IXmPlGQZUp34
# a20NBBIJ0iDyLnMzmrkP5uE1kogrAS34fEWvXmRN3sJlJjLZV56V6lBkhWT2E7lG
# faM9cmiYlYx6Gyh5QMjUF9ao6H/0X9Q7LS1P7vhp32c43IK57hEx8STFq0914P9k
# ZG+32f37lVnJLLcBd59Vw1CwVAvSG308jpxovBq+uoC9P6HAGF/BA+OcnO5UeXlB
# BzV1LXmjGOWZofZ3DBrj3bgoMdbKANkL0/zjEsa/VRLN+Sx/fMXJhroQmZglH6XM
# VkV9RI5pjysR+KJ/0e933c9alT4k6Yf5JffZoTbd7u2b+tRnh6bpipQAfjL2nixn
# Vc3NPWsv4JhZzVEJRNQUHVdqn9yemvA0WrhdOmqtuIWhAlCjqL5r9XaV+h04JHHI
# iy8TAkKg6Tqy0DS6hvQ3Ce1C80Lq7ZwH7EMZrWcvBEAuqkfpFZ7BfKNsJp38RxNY
# d0Hq91aoSjBSbPvnsoqmbQlp/d36U0GAQaee8XWLlvJJsXo5yAMoSiZradjjjH/v
# OWFgIgFpNSXYM3Vxha8PvkruKleMDcHVNu8=
